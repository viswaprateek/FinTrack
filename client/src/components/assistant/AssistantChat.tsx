...
export function AssistantChat() {
  ...
  return (
    <div className="flex h-[520px] w-[380px] flex-col overflow-hidden rounded-2xl border border-slate-800 bg-slate-950 shadow-2xl shadow-black/40">
      <header className="flex items-center justify-between border-b border-slate-800 bg-slate-900 px-4 py-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-sm font-semibold text-slate-100">Finance Assistant</p>
      ...
      <div ref={listRef} className="flex-1 space-y-3 overflow-y-auto px-4 py-4">
            ...
            <div className="flex flex-wrap gap-2">
              {SUGGESTIONS.map((suggestion) => (
                <button
                  ...
                  className="rounded-full border border-slate-700 bg-slate-900 px-3 py-1.5 text-xs text-slate-300 transition-colors hover:border-purple-500 hover:text-white"
                >
                  {suggestion}
                </button>
              ))}
        ...
        {isLoading && (
          <div className="flex justify-start">
            <div className="rounded-2xl border border-slate-800 bg-slate-900 px-4 py-3 text-slate-400">
